...
| Write and select | Focus a long note in the middle and at the end, type, hold a stationary interior long press for three seconds before/after focus, select across lines, scroll to the end with keyboard shown/hidden, drag keyboard down and reverse, resume editing | Long wrapped selection, scroll while selecting, checklist toggle, undo, edit a link | Input lag, runaway selection autoscroll, caret jumps, reflow, discontinuous dismissal |
